...
![FashionMNIST Scaling Performance](img/fashionmnist_scaling_performance.png){.block width=70%}
...
![CIFAR-10 Scaling Performance](img/cifar10_scaling_performance.png){.block width=70%}
