#!/usr/bin/env python3
"""
Convert front_zh.png to cover_front_zh.pdf for Amazon KDP 7×10 inch trim size.
Preserves aspect ratio (no stretch).
Input:  cover/7x10/front_zh.png
Output: cover/7x10/cover_front_zh.pdf at 300 DPI (2100×3000 px)
"""
...
def main() -> None:
    ...
    input_path = script_dir / "front_zh.png"
    output_path = script_dir / "cover_front_zh.pdf"

    if not input_path.exists():
        raise FileNotFoundError(f"Chinese front cover PNG not found: {input_path}")
    ...
    print(f"Chinese front cover generated: {output_path}")
