...
- **Chapter 7** (`chapter7-cross-request-optimization-with-sglang/code/`) — Cross-request optimization and SGLang examples.
- **Chapter 8** (`chapter8-running-distributed-training-with-slurm/code/`) — Distributed training examples.
