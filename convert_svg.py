...
def convert_foreignobject_to_text(svg_file, output_file):
    """Convert foreignObject elements to native SVG text elements."""
    ...
    print(f"Found {len(foreign_objects)} foreignObject elements")
...
if __name__ == "__main__":
    convert_foreignobject_to_text('training_tree.svg', 'training_tree_fixed.svg')
    convert_foreignobject_to_text('inference_tree.svg', 'inference_tree_fixed.svg')
