...
\usepackage{pdfpages}  % For including part PDFs
...
\NewDocumentEnvironment{chaptertitlepage}{m m m O{} O{}}{%
  \newpage
  \thispagestyle{empty}
  % Set chapter counter to match the chapter number
  % This ensures section numbering is correct (e.g., 1.1, 1.2, not 0.1, 0.2)
  \setcounter{chapter}{#1}
  \setcounter{section}{0}
  \setcounter{subsection}{0}
  % Add chapter title to TOC (book class uses 'chapter' entry type)
  % In book class, hyperref automatically creates bookmarks from \addcontentsline entries
  % Clean LaTeX line break commands from title for both TOC and bookmarks
  \StrSubstitute{#2}{\\[0.3cm]}{ }[\@cleantitle]
  \StrSubstitute{\@cleantitle}{\\[0.5cm]}{ }[\@cleantitle]
  \StrSubstitute{\@cleantitle}{\\[0.6cm]}{ }[\@cleantitle]
  \phantomsection
  % Use cleaned title in \addcontentsline - hyperref will create bookmark from this cleaned text
  \addcontentsline{toc}{chapter}{Chapter #1: \@cleantitle}
  \vspace*{-2cm}
