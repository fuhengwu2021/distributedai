...
ax.text(2.25, 4.4, "SLURM Variables", ha="center", va="center", fontsize=11, fontweight="bold")
...
for i, (var, desc) in enumerate(slurm_vars):
    y = 3.8 - i * 0.7
    ax.text(0.7, y, var, ha="left", va="center", fontsize=10, fontweight="bold", family="monospace")
    ax.text(0.7, y - 0.25, desc, ha="left", va="center", fontsize=8, color="#555555")
...
ax.text(7.75, 4.4, "PyTorch Variables", ha="center", va="center", fontsize=11, fontweight="bold")
...
for i, (var, desc) in enumerate(pytorch_vars):
    y = 3.8 - i * 0.7
    ax.text(6.2, y, var, ha="left", va="center", fontsize=10, fontweight="bold", family="monospace")
    ax.text(6.2, y - 0.25, desc, ha="left", va="center", fontsize=8, color="#555555")

# Arrows showing mapping
arrow_mappings = [
    (3.8, 3.8, 6.0, 3.8),   # SLURM_PROCID -> RANK
    (3.8, 3.1, 6.0, 3.1),   # SLURM_LOCALID -> LOCAL_RANK
    (3.8, 2.4, 6.0, 2.4),   # SLURM_NTASKS -> WORLD_SIZE
    (3.8, 1.0, 6.0, 1.0),   # SLURM_JOB_NODELIST -> MASTER_ADDR
]
...
# Center label
ax.text(4.9, 2.7, "export\nor\ntorchrun", ha="center", va="center", fontsize=9, 
